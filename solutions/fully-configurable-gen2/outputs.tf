...
output "next_steps_text" {
  value       = "Your IBM Cloud Messages Gen 2 (VPC) for RabbitMQ instance is ready. You can now take advantage of multiple messaging protocols, achieve customizable persistence levels and low latency, while routing, tracking, and queuing messages in a fully managed, distributed system."
...
output "next_step_secondary_url" {
  value       = "https://cloud.ibm.com/docs/messages-for-rabbitmq-gen2"
