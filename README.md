...
| <a name="module_cbr_rule"></a> [cbr\_rule](#module\_cbr\_rule) | git::https://github.com/terraform-ibm-modules/terraform-ibm-cbr//modules/cbr-rule-module | v1.29.0 |
...
| <a name="input_service_endpoints"></a> [service\_endpoints](#input\_service\_endpoints) | Endpoints available to the database instance (public, private, public-and-private) | `string` | `"private"` | no |
